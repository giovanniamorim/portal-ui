import { IModoPagamento } from "./modo-pagamento.interface";
import { IProfundidade } from "./profundidade.interface";
import { ITipoComprovante } from "./tipo-comprovante.interface";
...
export const MODOS_PAGAMENTOS: IModoPagamento[] = [
    { nome: 'Dinheiro'}, 
    { nome: 'Cheque'}, 
  ...
  export const TIPOS_COMPROVANTES: ITipoComprovante[] = [
    { nome: 'Boleto'}, 
    { nome: 'Recibo'}, 
    { nome: 'Cupom Fiscal'},
    { nome: 'Nota Fiscal'},
  ...
  export const PROFUNDIDADES: IProfundidade[] = [
    { nome: 'Analítica'}, 
    { nome: 'Sintética'}
  ];

export const CONTAS: IContas[]  = [
    {
        contaPai: '', 
        codigo: '3', 
