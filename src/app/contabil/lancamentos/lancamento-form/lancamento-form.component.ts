...
export class LancamentoFormComponent implements OnInit  {
  ...
  filteredContas: any = new ReplaySubject(1);
  filteredReceitas: any = new ReplaySubject(1);
  filteredDespesas: any = new ReplaySubject(1);
  ...
  ngOnInit(): void {
    ...
    if(this.router.url.includes(`/lancamentos/receitas/editar/`)){
      ...
      this.inicialFileName = "receita_"
      this.lancamentoFileName = `${this.inicialFileName}${this.currentId}.jpg`
    }

    if(this.router.url.includes(`/lancamentos/despesas/editar/`)){
      this.isEditLancamento = true
      this.currentId =  parseInt(this.router.url.substring(29))
      this.inicialFileName = "despesa_"
      this.lancamentoFileName = `${this.inicialFileName}${this.currentId}.jpg`
    }

    if(this.router.url.includes(`/lancamentos/novo`)){
  ...
  onSelectChange(event:any): void {
    ...
    console.log("Inicial file name:", this.inicialFileName
    );
